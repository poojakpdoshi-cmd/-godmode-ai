...
export default function GodmodeChatWorkspace() {
  ...
  async function persistConfiguration() {
    ...
    try {
      ...
      await configureChat.mutateAsync({ conversationId: activeConversationId, systemPrompt: normalizedPrompt || null, mode, selections: selectedModels });
