  ...
  async function submitMessage(event?: FormEvent) {
    ...
    try {
      if (mode === "solo" && !researchMode && selectedModels[0]?.providerId === "openrouter") {
        setIsStreaming(true); setStreamingContent(""); setStreamFirstTokenMs(null); setStreamStatus("Opening strict free fast route…"); setStreamModelId("OpenRouter free fast route");
